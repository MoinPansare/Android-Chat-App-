...
public class HttpUpload extends AsyncTask<Void, Integer, Void> {
    ...
    private static final String url = "http://192.168.1.108:3000/upload";

    public HttpUpload(Context context, File my_file , Uri tempUri) {
        super();
    ...
    protected Void doInBackground(Void... params) {
        try {
            ...
            ContentBody cbFile = new FileBody( my_file, "image/jpeg" );
